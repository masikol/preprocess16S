...
def SW_get_new_score(up, left, middle,
    ...
    return max(0, middle+(mismatch, match)[matched], left-gap_penalty, up-gap_penalty)
#}
...
def SW_align(jseq, iseq, gap_penalty=5, match=1, mismatch=-1):#{
    ...
    return SW_get_alignment(max_pos, jseq, iseq, SWsm, gap_penalty, match, mismatch)
#}
